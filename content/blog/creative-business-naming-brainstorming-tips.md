...
<h2 class="text-4xl font-bold text-gunmetal">1. Create a word map</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">2. Take inspiration from a foreign language</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">3. Talk about it with your friends</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">4. Use a misspelling of a common word</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">5. Create a mood board</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">6. Start by designing a logo</h2>
...
<h2 class="text-4xl font-bold text-gunmetal">7. Use an unrelated word</h2>
